...
class _HomePageState extends State<HomePage> {
  ...
  void getCategories() async {
    ...
    var res = await get(
        Uri.parse("${dotenv.env['BASE_URL']}/categories/getCategories"));
  ...
  void getMovies() async {
    await dotenv.load(fileName: ".env");
    var res =
        await get(Uri.parse("${dotenv.env['BASE_URL']}/movies/getMovies"));
                          ...
                          .map((categorie) => Container(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: ((selectedCategorie ==
                                            categorie["name"])
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        color:
                                            const Color.fromARGB(255, 2, 1, 17),
                                      ),
                                      height: 230.0,

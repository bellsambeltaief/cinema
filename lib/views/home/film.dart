  ...
  Future<void> _getFilms() async {
    try {
      final response = await http.get(
        ...
        Uri.parse('http://localhost:5000/films/categorie/:idCategorie",getFilmsByIdCategorie'),
      );
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return    Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  context, MaterialPageRoute(builder: (context) => MovieDetail(movieData: film)));
                            },
                            child: Container(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () {
                                            Navigator.push(
                                                context, MaterialPageRoute(builder: (context) => Booking(movieData: film)));

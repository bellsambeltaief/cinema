                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                            MovieTiming(time:     (parseDate(widget.movieData["date"])), timeText: "Date"),
                              MovieTiming(timeText: 'Time Start', time: widget.movieData["timestart"],),
                                 MovieTiming(timeText: 'Time End', time:  widget.movieData["timeend"],),
                            ],
                          ),
                        ),
                        Container(
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            MovieDescription(title:   widget.movieData["description"],),
                            Container(
                              margin: const EdgeInsets.fromLTRB(
                                  10.0, 0, 0, 10.0),
                              child: Text(
